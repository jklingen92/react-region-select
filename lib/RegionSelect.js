...
var RegionSelect = function (_Component) {
	...
	_createClass(RegionSelect, [{
		...
		value: function onDocMouseTouchMove(event) {
			...
			if (width < this.props.minWidth || height < this.props.minHeight || width > this.props.maxWidth || height < this.props.maxHeight) this.props.onChange([].concat(_toConsumableArray(this.props.regions.slice(0, index)), [(0, _objectAssign2.default)({}, updatingRegion, rect)], _toConsumableArray(this.props.regions.slice(index + 1))));
		}
	}, {
